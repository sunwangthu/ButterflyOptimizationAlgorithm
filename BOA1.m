...
%
function [fmin,best_pos,Convergence_curve]=BOA1(n,N_iter,Lb,Ub,dim,fobj)
...
Sol=initialization1(n,dim,Ub,Lb);

for i=1:n,
    Fitness(i)=fobj(Sol(i,:));%fobj是目标函数，object function
end
